  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
        ...
        <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
            ...
            {/* BY INSPECT WE CAN SEE THAT WHEN WE ARE CLIKING ON ANY NAVLINK THEN USKI CLASS MEIN active AA JA RHA HAI MEANS THAT PAGE IS ACTIVE */}

            {/* YAHAN SABKO HIDDEN KARNE SE JO PAGE OPEN HOGA WO USPE HI AAYEGA  */}
